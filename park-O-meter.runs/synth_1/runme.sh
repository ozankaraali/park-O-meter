...
HD_PWD='Z:/mahmut/park-O-meter/park-O-meter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_controller.tcl
